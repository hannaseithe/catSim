...
def test_simulation_method_generate_initial_state(sample_sim):
    ...
    assert len(sample_sim.state.edges) == 9
    assert len(sample_sim.state.relationships) == 3

    assert sample_sim.state.cats[0].current_node == 4
    assert sample_sim.state.cats[1].current_node == 5
    assert sample_sim.state.cats[2].current_node == 0
...
def test_simulation_method_movement_step(sample_sim):
    ...
    assert sample_sim.state.cats[0].stats.times_at_home == 0
    ...
    assert sample_sim.state.cats[0].stats.iter_at_home == 3
    assert sample_sim.state.cats[1].stats.iter_at_home == 1
    assert sample_sim.state.cats[2].stats.iter_at_home == 1

    assert sample_sim.state.cats[0].stats.iter_at_neutral == 0
    ...
    assert sample_sim.state.cats[2].stats.iter_at_friendly == 1

    assert sample_sim.state.cats[0].stats.iter_on_edge == 0
    assert sample_sim.state.cats[1].stats.iter_on_edge == 1
    assert sample_sim.state.cats[2].stats.iter_on_edge == 1
...
def test_simulation_method_engagement_step(sample_sim):
    ...
    assert sample_sim.state.cats[0].stats.sleeps == 1
    assert sample_sim.state.cats[1].stats.sleeps == 0
    assert sample_sim.state.cats[2].stats.sleeps == 0
...
def test_simulation_method_run(sample_sim):
    ...
    assert sample_sim.state.cats[0].stats.sleeps == 20
    assert sample_sim.state.cats[0].stats.iter_at_home == 10
    assert sample_sim.state.cats[0].stats.iter_at_neutral == 9
    assert sample_sim.state.cats[0].stats.iter_at_friendly == 1
    assert sample_sim.state.cats[0].stats.iter_on_edge == 10
    assert sample_sim.state.cats[0].stats.times_at_home == 4

    assert sample_sim.state.cats[0].metrics.average_iter_spent_at_friends_home == 1.0
    assert sample_sim.state.cats[0].metrics.average_iter_spent_at_home == 2.5
    assert sample_sim.state.cats[0].metrics.average_iter_spent_on_neutral_node == 1.8
    ...
    assert sample_sim.state.cats[0].metrics.exploration_index == 0.5714285714285714
    ...
    assert sample_sim.state.cats[0].metrics.percent_time_spent_home == 0.3333333333333333
    assert sample_sim.state.cats[0].metrics.percent_time_spent_on_edge == 0.3333333333333333
    assert sample_sim.state.cats[0].metrics.percent_time_spent_on_neutral_ground == 0.3
    assert sample_sim.state.cats[0].metrics.percent_time_spent_sleeping == 0.6666666666666666
